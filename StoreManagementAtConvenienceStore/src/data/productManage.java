  ...
  //-----------------------------------Add-------------------------------------------       
    public void handleAddProduct(){
        ...
        do{
           ...
           int newExpiryDay;
           if (newExpiryMonth == 2) {
                    newExpiryDay = Inputter.getAnIteger(">Enter day of Expiry (1-28): ", ">Day between 1-28", 1, 28);
                } else if (newExpiryMonth == 4 || newExpiryMonth == 6 || newExpiryMonth == 9 || newExpiryMonth == 11) {
                    newExpiryDay = Inputter.getAnIteger(">Enter day of Expiry (1-30): ", ">Day between 1-30", 1, 30);
                } else {
                    newExpiryDay = Inputter.getAnIteger(">Enter day of Expiry (1-31): ", ">Day between 1-31", 1, 31);
                }
           ...
           Product nProduct = new Product(newProductID , newProductName, newManufactureDate, newExpiryDate, quantity, price);
...
//----------------------UseAgain-----------------------------
    ...
    //--------------------------------------------------------------2. manage import/export product----------------------------------------------------------
